                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <Link to='/'>
                                <span className="font-bold text-2xl text-green-600">Dr.  Aminul</span></Link>
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        {user?.email ? (
                            <>
                                <div className="hidden md:flex items-center space-x-1  ">
                                    <Link to='/add-service' className="py-5 px-3 text-gray-700 hover:text-gray-900 font-bold">Add Service</Link>
